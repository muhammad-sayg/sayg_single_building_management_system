    ...
    <section class="section">
        <ul class="breadcrumb breadcrumb-style ">
          <li class="breadcrumb-item">
            <h4 class="page-title m-b-0">Security Deposit Create</h4>
          </li>
          <li class="breadcrumb-item">
        ...
        <div class="section-body">
            <form method="POST" action="{{ route('securitydeposit.store') }}" enctype="multipart/form-data">
                @csrf
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                             ...
                             <div class="card-body">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="tenant_email_address"  class="form-control">
                                </div>
                                <div class="form-group col-md-4" >
                                 <label>Floor</label>
                                  ...
                                  <option value="">---Select---</option>
                                   @if(isset($floors_list) && $floors_list->isNotEmpty())
                                      ...
                                      <div class="form-group col-md-4">
                                        <label>Amount</label>
                                       <input type="text" name="security_deposite_total_amount" class="form-control">
                                </div>
                        </div>
